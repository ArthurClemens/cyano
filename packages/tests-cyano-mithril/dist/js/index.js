...
/***/ "../../tests-cyano-shared/Counter.js":
/*!***************************************************************************************!*\
  !*** /Users/arthur/code/Github Projects/cyano/packages/tests-cyano-shared/Counter.js ***!
  \***************************************************************************************/
...
var Counter = function Counter(_ref) {
  ...
  var dom = useRef();
  var domCountElement = useRef();

  var remove = function remove() {
    var removeOnTransitionEnd = function removeOnTransitionEnd() {
      return removeCounter(id), dom.current.removeEventListener("transitionend", removeOnTransitionEnd);
    };
  ...
  return h(".counter", {
    ...
    oncreate: function oncreate(vnode) {
      return dom.current = vnode.dom;
    }
  }, h(".counter-inner", [h(".count", {
    oncreate: function oncreate(vnode) {
      return domCountElement.current = vnode.dom;
    }
  ...
  }), h("span.icon.is-small", h("i.fas.fa-minus"))), h("button", _defineProperty({
    className: "button"
  }, a.onclick, function () {
    return dispatch({
      type: "increment"
    });
  }), h("span.icon.is-small", h("i.fas.fa-plus"))), h(".spacer"), h("button", _defineProperty({
...
/***/ "../../tests-cyano-shared/Toggle.js":
/*!**************************************************************************************!*\
  !*** /Users/arthur/code/Github Projects/cyano/packages/tests-cyano-shared/Toggle.js ***!
  \**************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "../../tests-cyano-shared/customHooks.js":
/*!*******************************************************************************************!*\
  !*** /Users/arthur/code/Github Projects/cyano/packages/tests-cyano-shared/customHooks.js ***!
  \*******************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/*!*********************************************************************************************************!*\
  ...
  \*********************************************************************************************************/
/*! exports provided: hooks, CustomHooks */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "hooks", function() { return hooks; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CustomHooks", function() { return CustomHooks; });
function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
var CustomHooks = function CustomHooks(_ref2) {
  ...
  return [h("[data-test-id=TestCounter]", [h("h2", "TestCounter"), h("p", [h("span", "count: "), h("span[data-test-id=count]", count)]), h("button[data-test-id=decrement]", _defineProperty({
    disabled: count === 0
  }, a.onclick, function () {
    return decrement();
  }), "Less"), h("button[data-test-id=increment]", _defineProperty({}, a.onclick, function () {
    return increment();
  }), "More")]), h("[data-test-id=TestCounters]", [h("h2", "TestCounters"), h("p", [h("span", "counters: "), h("span[data-test-id=counters]", counters.length)]), h("button[data-test-id=decrement]", _defineProperty({
    disabled: counters.length === 0
  }, a.onclick, function () {
    return removeCounter(lastItem);
  }), "Remove"), h("button[data-test-id=increment]", _defineProperty({}, a.onclick, function () {
    return addCounter();
  }), "Add")])];
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var cyano_mithril__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! cyano-mithril */ "../../cyano-mithril/dist/cyano-mithril.mjs");
/* harmony import */ var tests_cyano_shared_Counter__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! tests-cyano-shared/Counter */ "../../tests-cyano-shared/Counter.js");
/* harmony import */ var tests_cyano_shared_customHooks__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! tests-cyano-shared/customHooks */ "../../tests-cyano-shared/customHooks.js");
function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
var CounterController = function CounterController(_ref) {
  var useCounter = _ref.useCounter,
      h = _ref.h,
      a = _ref.a,
  ...
  return [h(".controls", [h("button", _defineProperty({
    className: "button is-info"
  }, a.onclick, function () {
    return addCounter();
  }), "Add counter"), h(".spacer"), h("span.info", h("span", {
...
/* harmony default export */ __webpack_exports__["default"] = (Object(cyano_mithril__WEBPACK_IMPORTED_MODULE_0__["createComponent"])(CounterController, tests_cyano_shared_customHooks__WEBPACK_IMPORTED_MODULE_2__["default"], {
  Counter: Object(cyano_mithril__WEBPACK_IMPORTED_MODULE_0__["createComponent"])(tests_cyano_shared_Counter__WEBPACK_IMPORTED_MODULE_1__["default"], tests_cyano_shared_customHooks__WEBPACK_IMPORTED_MODULE_2__["default"])
}));

/***/ }),

/***/ "./cypress-tests/TestCustomHooks.js":
/*!******************************************!*\
  !*** ./cypress-tests/TestCustomHooks.js ***!
  \******************************************/
/*! exports provided: default */
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var cyano_mithril__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! cyano-mithril */ "../../cyano-mithril/dist/cyano-mithril.mjs");
/* harmony import */ var tests_cyano_shared_cypress_tests_CustomHooks__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! tests-cyano-shared/cypress-tests/CustomHooks */ "../../tests-cyano-shared/cypress-tests/CustomHooks.js");


/* harmony default export */ __webpack_exports__["default"] = (Object(cyano_mithril__WEBPACK_IMPORTED_MODULE_0__["createComponent"])(tests_cyano_shared_cypress_tests_CustomHooks__WEBPACK_IMPORTED_MODULE_1__["CustomHooks"], tests_cyano_shared_cypress_tests_CustomHooks__WEBPACK_IMPORTED_MODULE_1__["hooks"]));
...
/* harmony import */ var _custom_hooks_usereducer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./custom-hooks-usereducer */ "./custom-hooks-usereducer.js");
/* harmony import */ var _toggle__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./toggle */ "./toggle.js");
/* harmony import */ var _cypress_tests_TestCustomHooks__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./cypress-tests/TestCustomHooks */ "./cypress-tests/TestCustomHooks.js");
function _slicedToArray(arr, i) { return _arrayWithHoles(arr) || _iterableToArrayLimit(arr, i) || _nonIterableRest(); }
...
var links = [["Simple toggle", "/toggle", _toggle__WEBPACK_IMPORTED_MODULE_2__["default"]], ["Custom hooks with useReducer", "/custom-hooks-usereducer", _custom_hooks_usereducer__WEBPACK_IMPORTED_MODULE_1__["default"]]];
var tests = [["Test custom hooks", "/TestCustomHooks", _cypress_tests_TestCustomHooks__WEBPACK_IMPORTED_MODULE_3__["default"]]];

var link = function link(href, currentRoute, label) {
...
var createMenu = function createMenu(currentRoute) {
  return mithril__WEBPACK_IMPORTED_MODULE_0___default()("aside.menu", [mithril__WEBPACK_IMPORTED_MODULE_0___default()("p.menu-label", "Cyano for Mithril Demos"), mithril__WEBPACK_IMPORTED_MODULE_0___default()("ul.menu-list", links.map(function (_ref) {
    var _ref2 = _slicedToArray(_ref, 2),
        label = _ref2[0],
        href = _ref2[1];

    return link(href, currentRoute, label);
  })), tests.length ? [mithril__WEBPACK_IMPORTED_MODULE_0___default()("p.menu-label", "Cypress tests"), mithril__WEBPACK_IMPORTED_MODULE_0___default()("ul.menu-list", tests.map(function (_ref3) {
...
var Layout = {
  view: function view(vnode) {
    return mithril__WEBPACK_IMPORTED_MODULE_0___default()(".layout", [createMenu(mithril__WEBPACK_IMPORTED_MODULE_0___default.a.route.get()), mithril__WEBPACK_IMPORTED_MODULE_0___default()(".component", vnode.children)]);
  }
};
var root = document.getElementById("root");
var allLinks = links.concat(tests);
var routes = allLinks.reduce(function (acc, _ref5) {
...
var _allLinks$ = _slicedToArray(allLinks[0], 2),
    firstRoute = _allLinks$[1];

mithril__WEBPACK_IMPORTED_MODULE_0___default.a.route(root, firstRoute, routes);
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var cyano_mithril__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! cyano-mithril */ "../../cyano-mithril/dist/cyano-mithril.mjs");
/* harmony import */ var tests_cyano_shared_Toggle__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! tests-cyano-shared/Toggle */ "../../tests-cyano-shared/Toggle.js");


/* harmony default export */ __webpack_exports__["default"] = (Object(cyano_mithril__WEBPACK_IMPORTED_MODULE_0__["createComponent"])(tests_cyano_shared_Toggle__WEBPACK_IMPORTED_MODULE_1__["default"]));

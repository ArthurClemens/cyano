...
declare function renderFunction(children?: Children | ReadonlyArray<RenderElement> | RenderElement): ReactElement;
declare function renderFunction<P = unknown>(componentOrTag: FunctionComponent<P> | string, children?: Children | ReadonlyArray<RenderElement> | RenderElement): ReactElement;
declare function renderFunction<P = unknown>(componentOrTag: FunctionComponent<P> | string, properties: P | null, children?: Children | ReadonlyArray<RenderElement> | RenderElement): ReactElement<P>;
type FragmentProps = {
    [key: string]: string | number;
};
type HyperScript = typeof renderFunction & {
    trust: (html: string, wrapper?: string) => ReactElement<{
...
export declare function cast<Props = unknown, TRef = unknown>(component: FunctionComponent<Props & {
    ref: ForwardedRef<TRef>;
}>, initialProps?: Partial<Props>): React.ForwardRefExoticComponent<React.PropsWithoutRef<Props> & React.RefAttributes<TRef>>;
